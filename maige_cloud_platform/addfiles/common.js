window.jQuery && !window.handleHeaderProduct && (window.handleHeaderProduct = function() {
	...
	}), $("#headerNav").on("mouseenter", ".elian-header-sub a", function() {
		var e = $(this),
			t = e.closest(".elian-header-sub"),
			i = t.find("a");
		i.each(function() {
			$(this)[0] !== e[0] && ($(this).css("opacity", "0.5"), $(this).css("filter", 'alpha(opacity="50")'))
		})
	}).on("mouseleave", ".elian-header-sub a", function() {
		var e = $(this),
			t = e.closest(".elian-header-sub"),
			i = t.find("a");
		i.each(function() {
	...
	}), t.on("mouseover", ".elian-header-link > li", function() {
		var e = $(this),
			i = $("#elian-header-sub-" + e.data("subnav")),
			o = !!$(".elian-header-sub:visible").length;
		$(".elian-header-sub").hide(), e.hasClass("elian-header-link-product") && (o ? i.show() : i.slideDown("fast")), t.addClass("toggle")
	}).on("mouseout", function() {
		e = setTimeout(function() {
			$(".elian-header-sub").hide(), t.removeClass("toggle")
		}, 200)
	}), window.navigator.userAgent.indexOf("MSIE 7.0") > -1 && (document.getElementById("headerNav").onclick = function(e) {
		var e = e || window.event,
			t = e.targetElement || e.srcElement;
		return "IMG" === t.tagName.toUpperCase() && t.parentNode.className.indexOf("elian-header-sub-img") > -1 ? (t = t.parentNode.parentNode, window.location.href = t.href, !1) : void 0
	}), 1
}()), $(function() {
	function e() {
	...
	var t = $(window),
		...
		c = 0,
		u = 0,
		l = ($("#elian-header").height(), r.outerHeight()),
		h = r.offset() ? r.offset().top : 0;
	...
	}, isMac() && $("body").addClass("mac"), $("body").addClass(isIE() ? "ie" : "notIE"), window.Cookie = {
		set: function(e, t, i) {
			if (i) {
				var o = new Date;
			...
			document.cookie = e + "=" + t + n + "; domain=.elian.com;path=/"
		},
		get: function(e) {
	...
	p.each(isRetina() ? function() {
	...
	}, Cookie.get("subnavShow") || (Cookie.set("subnavShow", "1", 240), e(), setTimeout(e, 2e3)), $(".subnav-disclosure").on("click", function() {
		e()
	}), setTimeout(function() {
		t.scroll(function() {
			r.hasClass("open") && e()
		...
		var i = !0;
		t.scroll(function() {
			c = t.scrollTop(), u = t.scrollLeft(), c > h ? r.addClass("fixed").css("left", -u) : r.removeClass("fixed").css("left", 0), 1 === e && (c > d ? c > h + l ? 1 == i && (i = !1, r.animate({
				top: -l
			}, 200, "linear", function() {
				i = !0
		...
		this.videoWidth = e.videoWidth ? e.videoWidth : 960, this.videoHeight = e.videoHeight ? e.videoHeight : 540, this.playerWrapId = e.playerWrapId ? e.playerWrapId : "player1", this.$playerWrap = $("#" + this.playerWrapId), this.$player = $(".jp-jplayer", this.$playerWrap), this.$jpMask = $(".jp-mask", this.$playerWrap);
		var i = this;
		return this.$player.jPlayer({
			...
			swfPath: "http://www2.res.elian.com/zh_cn/videos",
		...
		var e = this,
			...
			n = i.scrollTop(),
			a = t.height();
		n = i.scrollTop(), $("body").addClass("vh"), $(".jp-mask, .jp_container", e.$playerWrap).show(), this.$jpMask.height(o).css({
			top: n
		...
		var e = this;
		$("body").removeClass("vh"), $(".jp-mask, .jp_container", e.$playerWrap).hide(), e.$player.jPlayer("pause")
		...
		getViewport().width < 1080 ? (i.addClass("JSWrapperWidth"), r.addClass("JSWrapperWidth"), o.addClass("JSWrapperWidth"), a.css("width", "1080px")) : (i.removeClass("JSWrapperWidth"), r.removeClass("JSWrapperWidth"), o.removeClass("JSWrapperWidth"), a.css("width", "100%"))
	}), s.click(function() {
		$("html,body").animate({
			scrollTop: 0
		}, 500)
